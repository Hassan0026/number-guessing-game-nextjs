...
export default function NumberGuessing(): JSX.Element {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-red-300 to-yellow-300">
          <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md bg-gradient-to-br from-red-200 to-yellow-200">
            ...
            {gameStarted && !gameOver && (
              <div>
                ...
                <div className="flex justify-center mb-4">
                  ...
                  <Button
                    onClick={handleGuess}
                    className="bg-blue-800 hover:bg-green-600 text-white font-bold py-2 px-4 rounded ml-4"
                  >
                    Guess
                  </Button>
                </div>
